...
func (x *AddProductReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.Picture, offset, err = fastpb.ReadBytes(buf, _type)
	return offset, err
}
...
func (x *AddProductReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteBytes(buf[offset:], 3, x.GetPicture())
	return offset
}
...
func (x *AddProductReq) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 5, x.GetStock())
	return offset
}
...
func (x *UpdateProductReq) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteBytes(buf[offset:], 4, x.GetPicture())
	return offset
}
...
func (x *AddProductReq) sizeField3() (n int) {
	...
	n += fastpb.SizeBytes(3, x.GetPicture())
	return n
}
...
func (x *AddProductReq) sizeField5() (n int) {
	...
	n += fastpb.SizeUint32(5, x.GetStock())
	return n
}
...
func (x *UpdateProductReq) sizeField4() (n int) {
	...
	n += fastpb.SizeBytes(4, x.GetPicture())
	return n
}
